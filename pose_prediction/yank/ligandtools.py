...
def writeMolecule(molecule, filename, substructure_name = 'MOL', preserve_atomtypes = False):
   ...
   return
#=============================================================================================
def parameterizeForAmber(molecule, topology_filename=None, coordinate_filename=None, charge_model = False, judgetypes = None, cleanup = True, show_warnings = True, verbose = False, resname = None, netcharge = None, offfile = None, ligand_obj_name = 'molecule', frcmod_filename = None):
   ...
   OPTIONAL ARGUMENTS
     ...
     gaff_mol2_filename - name of GAFF format mol2 file to be saved if desired (default: None)
...
quit""" % vars()
   ...
   # Copy amber topology/coordinates to desired output files.
   if coordinate_filename:
   ...
   if gaff_mol2_filename:
        commands.getoutput('cp %s %s' % (os.path.join(working_directory, 'gaff.mol2'), gaff_mol2_filename))
   if frcmod_filename:
