...
if __name__ == '__main__':
    ...
    pdbFilename = '3NF8.pdb'
    mymodel = ModelPDB()

    outputFilename = '3NF8_A.modeller.pdb'
    mymodel.modelMissingAtoms(pdbFilename, outputFilename, chain='A', debug=True, allHydrogen=False)

    outputFilename = '3NF8_B.modeller.pdb'
    mymodel.modelMissingAtoms(pdbFilename, outputFilename, chain='B', debug=True, allHydrogen=False)
